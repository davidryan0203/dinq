        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="/venue/edit">
                        @csrf

                        <div class="form-group row">
                            <label for="name" class="col-md-3 pull-left col-form-label">{{ __('Venue Name') }}</label>
                     
                            <div class="col-md-12">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $info['user']['name'] }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-3 pull-left col-form-label">{{ __('Description') }}</label>
